...
What if we wanted to test the hypothesis that there is no effect of fertilizer treatment on plant growth rate?
 Growth_rate_mm ~ Treatment, data = df_NO_NA
...
ggplot(df_All_NA, aes(Treatment, Growth_rate_mm))+
  ...
  theme_bw()
```
Looks like there will be a signficant effect of treatment and that level 1 and level 2 will be different from control. Not sure if Level 1 and Level 2 will differ from one another.
What do you think?

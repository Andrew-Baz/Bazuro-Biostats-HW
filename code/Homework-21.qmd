...
5.2 Always start by plotting data. THen attempt to understand the hypothesis that is being tested. X2 contingency analysis is an analysis of count data to test association between two or more categorical variables.
...
```{r}
ozone
ozone |> group_by(Garden.location) |> 
...
t.test(Ozone ~ Garden.location, 
       data = ozone)
var.test(Ozone ~ Garden.location, 
         data = ozone)
